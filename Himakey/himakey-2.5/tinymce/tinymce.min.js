...
! function(V) {
    ...
    var Ar = "\ufeff",
        ...
        Hr = (Vr.prototype.bind = function(e, t, n, r) {
            ...
            if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
                ...
                var p = t.split(" ");
                for (a = p.length; a--;) c = m, s = l = !1, "DOMContentLoaded" === (u = p[a]) && (u = "ready"), f.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, zr({
                    type: u
        ...
        return {
            ...
            requireLangPack: function(t, n) {
                !1 !== Ma.languageLoad && e(t, function() {
                    var e = Ia.getCode();
                    !e || n && -1 === ("," + (n || "") + ",").indexOf("," + e + ",") || Ra.ScriptLoader.add(s[t] + "/" + e + ".js")
                }, "loaded")
            },
            add: function(e, t, n) {
                var r = t;
    ...
    var Mf, Ff, Uf, zf, jf, Hf = If,
        ...
        Hm = function(r, e) {
            ...
            Um(t), t.on("focusin", function() {
                ...
                var t = r.activeEditor,
                    n = e.target;
                t && n.ownerDocument === V.document && (n === V.document.body || jm(t, n) || r.focusedEditor !== t || (t.fire("blur", {
                    focusedEditor: null
                }), r.focusedEditor = null))
        ...
        np = function(u, s, c) {
            return c.format = c.format ? c.format : "html", c.set = !0, c.content = ep(s) ? "" : s, ep(s) || c.no_events || (u.fire("BeforeSetContent", c), s = c.content), B.from(u.getBody()).fold(x(s), function(e) {
                ...
                }(u, e, s, c) : (t = u, n = e, o = c, 0 === (r = s).length || /^\s+$/.test(r) ? (a = '<br data-mce-bogus="1">', "TABLE" === n.nodeName ? r = "<tr><td>" + a + "</td></tr>" : /^(UL|OL)$/.test(n.nodeName) && (r = "<li>" + a + "</li>"), r = (i = Ys(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase()) ? (r = a, t.dom.createHTML(i, Gs(t), r)) : r || '<br data-mce-bogus="1">', tp(t, r), t.fire("SetContent", o)) : ("raw" !== o.format && (r = Of({
                    validate: t.validate
    ...
    var Ap, Dp, Op = /^(src|href|style)$/,
        ...
        Hp = function(s, c, l, e, f) {
            ...
            else if ("false" !== a.getContentEditable(t.getNode())) t.isCollapsed() && m.inline && !sf(s).length ? Np(s, c, l, f) : (gf(t, !0, function() {
                pf(s, n)
                ...
                B = function(n, e) {
                    if (e = e || O, n) {
                        if (e.onformat && e.onformat(n, e, A, r), Qp(e.styles, function(e, t) {
                            ...
                            t && i.setAttrib(n, "data-mce-style", t + "; height: 500px")
                        }
        ...
        Lg = function(s) {
            return {
                undoManager: {
                    ...
                    undo: function(e, t, n) {
                        return r = s, i = t, a = n, (o = e).typing && (o.add(), o.typing = !1, Ag(o, !1, i)), 0 < a.get() && (a.set(a.get() - 1), u = o.data[a.get()], Eg(r, u, !0), r.setDirty(!0), r.fire("Undo", {
                            level: u
                        })), u;
                        var r, o, i, a, u
                    },
                    redo: function(e, t) {
                        return n = s, o = t, (r = e).get() < o.length - 1 && (r.set(r.get() + 1), i = o[r.get()], Eg(n, i, !1), n.setDirty(!0), n.fire("Redo", {
                            level: i
                        })), i;
                        var n, r, o, i
                    },
        ...
        qg = function(e) {
            if (!e.removed) {
                ...
                r && e.save({
                    is_removing: !0
                }), e.removed = !0, e.unbindAllNativeEvents(), e.hasHiddenInput && o && Hg.remove(o.nextSibling), e.fire("remove"), e.editorManager.remove(e), !e.inline && r && (i = e, Hg.setStyle(i.id, "display", i.orgDisplay)), e.fire("detach"), Hg.remove(e.getContainer()), Vg(t), Vg(n), e.destroy()
            }
            var i
        },
        $g = function(e, t) {
            ...
            var e, u = a.dom,
                ...
                l = function(e, t) {
                    if (! function(e) {
                        ...
                        "" !== u.getAttrib(o, py) === i && !t || (u.setAttrib(o, py, i ? c : null), u.setAttrib(o, "aria-placeholder", i ? c : null), r = i, a.fire("PlaceholderToggle", {
                            state: r
    ...
    var Rb = function(o, i, a, e, u, t) {
        ...
        eC = function(l, f) {
            return function() {
                var e, t, n, r, o, i, a, u, s, c = (t = f, r = tl((e = l).getBody()), o = N(Hc, r.next), i = N(Hc, r.prev), a = t ? ws.Forwards : ws.Backwards, u = t ? o : i, s = e.selection.getRng(), (n = Jb(a, e, u, s)) ? n : (n = Zb(e, a, s)) || null);
                return !!c && (l.selection.setRng(c), !0)
            }
        },
        tC = function(u, s) {
            return function() {
                var e, t, n, r, o, i, a = (r = (t = s) ? 1 : -1, o = t ? Db : Ab, i = (e = u).selection.getRng(), (n = Qb(r, e, o, i)) ? n : (n = Zb(e, r, i)) || null);
        ...
        Jw = function(a, e) {
            ...
            if (w) {
                ...
                }(d, s), d.isEmpty(s) && qw(s), n.normalize(), d.isEmpty(n) ? (d.remove(n), y()) : (Gw(a, n), Mw(a, n))), d.setAttrib(n, "id", ""), a.fire("NewBlock", {
                    newBlock: n
                })
            }
        },
    ...
    function Yx(r) {
        ...
        "onselectionchange" in r.getDoc() || r.on("NodeChange click mouseup keyup focus", function(e) {
            ...
            !e || !mt.range && r.selection.isCollapsed() || mf(r) && !t.isSameElementPath(e) && r.dom.isChildOf(e, r.getBody()) && r.nodeChanged({
                selectionChange: !0
            })
    ...
    var Gx = function(e) {
        ...
        SS = function(e) {
            ...
            var n = Ks(e, "body_id", "tinymce"),
                r = Ks(e, "body_class", "");
            return Xs(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + Xs(e) + '" />'), t += '</head><body style="overflow: auto" id="' + n + '" class="mce-content-body ' + r + '" data-id="' + e.id + '"><br></body></html>'
        },
        NS = function(e, t) {
        ...
        PS = function(e, t) {
            ...
            if (!1 === Ia.hasCode(n) && "en" !== n) {
                var o = "" !== r ? r : t.editorManager.baseURL + "/" + n + ".js";
        ...
        LS = function(t, e, n) {
            return B.from(e).filter(function(e) {
                ...
                return {
                    url: t.editorManager.baseURL + "/icons" + n + ".js",
                    name: B.some(e)
                }
            })
        },
            ...
            ! function(e, t, n, r) {
                ...
                if (q(o)) {
                    if (!BS(o) && !Ch.urls.hasOwnProperty(o)) {
                        ...
                        i ? Ch.load(o, t.documentBaseURI.toAbsolute(i)) : Ch.load(o, "theme" + n + ".js")
                    }
    ...
    var mN, pN = function(n) {
        ...
        xN = function(e, t, n, r) {
            ...
            i.deactivate(), i.editorReadOnly !== a.editorReadOnly && uN(e, a.editorReadOnly), t.set(r), o = r, e.fire("SwitchMode", {
                mode: o
            })
        },
        SN = function(t) {
    ...
    var qN, $N, WN = Ea.DOM,
        ...
        oE = xe(xe({}, gN), {
            ...
            add: function(e) {
                var n = this;
                return QN[e.id] === e || (null === n.get(e.id) && ("length" !== e.id && (QN[e.id] = e), QN.push(e), ZN.push(e)), tE(!0), n.activeEditor = e, n.fire("AddEditor", {
                    editor: e
                }), qN || (qN = function(e) {
    ...
    var wE = Math.min,
        ...
        kE = xe(xe({}, gN), {
            send: function(e) {
                ...
                if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = !1 !== e.async, e.data = e.data || "", kE.fire("beforeInitialize", {
                        settings: e
