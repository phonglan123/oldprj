tinymce.addI18n('vi', {
    ...
    "Count": "Đếm",
    "Characters": "Kí tự",
    "Characters (no spaces)": "Kí tự (trừ khoảng cách)",
    "Document": "Văn bản",
    "Selection": "Phần được chọn",
    "Undo": "H\u1ee7y thao t\u00e1c",
    "Cut": "C\u1eaft",
    "Code sample...": "Khung code",
    "Copy": "Sao ch\u00e9p",
    "Paste": "D\u00e1n",
    ...
    "Name": "T\u00ean",
    "Id": "Id",
    "Id should start with a letter, followed only by letters, numbers, dashes, dots, colons or underscores.": "Id nên bắt đầu bằng một chữ cái, theo sau là chữ cái, số, dấu gạch ngang, dấu chấm, dấu hai chấm hoặc dấu gạch dưới.",
    ...
    "Plugins installed ({0}):": "Tiện ích bổ sung đã cài ({0}):",
    "Premium plugins:": "Tiện ích bổ sung cao cấp:",
    "Learn more...": "Tìm hiểu thêm...",
    "You are using {0}": "Bạn đang dùng {0}",
    ...
    "Anchors": "Neo",
    "Link": "Liên kết",
    "Paste or type a link": "Dán hoặc gõ một liên kết",
    ...
    "Match case": "Tìm kiếm trùng khớp (phân biệt chữ HOA - thường)",
    "Find whole words only": "Tìm kiếm trùng khớp",
    "Find in selection": "Tìm kiếm trong phần được chỉ định",
    "Alternative description": "Mô tả thay thế (khi hình ảnh gặp lỗi)",
    ...
    "Alternative source URL": "URL nguồn gốc",
    "Media poster (Image URL)": "Áp phích phương tiện (URL hình ảnh)",
    "Code view": "Xem mã",
    "All": "Tất cả",
    "Currency": "Tiền",
    "Text": "Văn bản",
    ...
    "Search": "Tìm kiếm",
    "People": "Người",
    "Animals and Nature": "Động vật và tự nhiên",
